		...
		<div class="row">
			...
			<div class="span9 rackerbook-column" style="min-height: 500px;">
				<div class="row">
					...
					<div class="span10">				
					<table id="signUpForm" class="signUpForm bordered-table">
					<thead>
					...
					<tbody>
						...
						<tr>
							<td colspan=2><h3>&nbsp;<input type="radio" />&nbsp;Male&nbsp;&nbsp;&nbsp;<input type="radio" />&nbsp;Female</h3></td>
						</tr>
						<tr id="signUpRow">
							<td colspan=2 style="text-align: center;"><a class="btn danger">Sign Up</a></td>
						</tr>
					<tbody>
					</table>
					</div>
