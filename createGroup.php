		...
		<div class="row">
			...
			<div class="span9 rackerbook-column" style="min-height: 500px;">
				<div class="row">
					...
					<div class="span10">
					<table id="createGroupForm" class="signUpForm bordered-table">
					<thead>
						<th colspan="2"><h3>Create New Group</h3></th>
					</thead>
					<tbody>
						<tr>
							<td colspan=2><input type="text" placeholder="Group Name" 
							style="width: 98%;"/></td>
						</tr>
						<tr>
							<td colspan=2>
							<textarea type="text" placeholder="Group Info/Description" 
							style="width: 98%; height: 50px; resize: none;" maxlength="500"/></textarea>
							</td>
						</tr>
						<tr>
							<td colspan=2>
						...
						<tr id="signUpRow">
							<td colspan=2 style="text-align: center;"><a class="btn danger">Create Group</a></td>
						</tr>
					<tbody>
					</table>
					</div>
